...
CREATE STORAGE INTEGRATION s3_int1
  TYPE = EXTERNAL_STAGE
  STORAGE_PROVIDER = 'S3'
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::298030125423:role/charishmareddys3-role'
  ENABLED = TRUE
  STORAGE_ALLOWED_LOCATIONS = ('s3://charishmareddy-snow-20/csv/','s3://charishmareddy-snow-20/json/');
...
CREATE OR REPLACE FILE FORMAT AWS_INT.file_formats.json_fileformat
    ...
    URL = 's3://charishmareddy-snow-20/json/'
    STORAGE_INTEGRATION = s3_int1
